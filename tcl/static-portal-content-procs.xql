...
<fullquery name="get_element_list">
   <querytext>
...
<fullquery name="select_element_id">
   <querytext>
              select value 
...
<fullquery name="update_content_item">
   <querytext>
...
<fullquery name="get_pretty_name.select">
   <querytext>
            select pretty_name
...
<fullquery name="get_package_id.select">
   <querytext>
            select package_id
            from static_portal_content 
            where content_id = :content_id
